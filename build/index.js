...
var callbackName = 'recaptchaOnLoad',
...
var CALLBACK_NAME = 'recaptchaFunction';
...
var ReCaptcha = function (_React$Component) {
  ...
  _createClass(ReCaptcha, [{
    ...
    key: 'onFormSubmit',
    value: function onFormSubmit(token) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement('div', {
          ...
          ref: function ref(recaptchaContainer) {
            _this3.recaptchaContainer = recaptchaContainer;
          }
        })
      );
    }
